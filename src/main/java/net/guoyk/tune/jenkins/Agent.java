package net.guoyk.tune.jenkins;
...
public class Agent {
    ...
    private static class UpdateSiteTransformer implements ClassFileTransformer {
        ...
        private static final String METHOD_NAME = "verifySignature";

        private static final String METHOD_BODY = "{ return hudson.util.FormValidation.ok(); }";
